  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const isValidLogin =
        ...
        (username === "maccarty29" && password === "dfgtre4sre2gtrerf")
              ...
              <div className="flex justify-between items-center">
                <label htmlFor="remember" className="flex items-center">
                  <input
                    ...
                    className="bg-[rgb(55,65,81)] border-[rgb(75,85,99)] transition-all duration-75 shadow-sm text-[rgb(217,119,6)] rounded appearance-none border-[0.8px] block h-4 w-4 p-0"
                    disabled={isLoading}
                  />
